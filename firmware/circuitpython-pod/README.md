...
- On BLE connection, re-notifies the most recent telemetry payload once, then continues once-per-minute telemetry notifications
...
7. Confirm you receive one latest-sample notification right after subscribe/connect and then a new notification once per minute.
