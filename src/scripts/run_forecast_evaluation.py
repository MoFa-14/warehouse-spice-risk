...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate an offline historical forecast report. Live forecast evaluation now updates automatically in the gateway forecasting runner."
    )
...
def main() -> int:
    args = parse_args()
    print(
        "Live forecast accuracy, retraining, and calibration now update automatically inside the gateway forecast runner. This script is offline reporting only.",
        file=sys.stderr,
    )
